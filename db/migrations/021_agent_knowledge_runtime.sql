...
CREATE TABLE agent_observations (
  ...
  node_id uuid NOT NULL REFERENCES nodes(id) ON DELETE CASCADE,
  workspace_id uuid NOT NULL REFERENCES workspaces(id) ON DELETE CASCADE,
  subject_type text NOT NULL CHECK (subject_type IN ('cko','claim','entity','relationship','source','project','decision')),
...
CREATE UNIQUE INDEX agent_delivery_event_uidx ON agent_delivery_receipts(subscription_id,event_id) WHERE event_id IS NOT NULL;
