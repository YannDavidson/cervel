...
CREATE TABLE corpus_membership_suppressions (
  ...
  UNIQUE NULLS NOT DISTINCT (corpus_id,cko_id,mega_tab,tab,subtab,enterprise_tenant_id)
);

CREATE INDEX corpus_membership_suppressions_cko_idx
  ON corpus_membership_suppressions(cko_id,corpus_id,created_at DESC);
