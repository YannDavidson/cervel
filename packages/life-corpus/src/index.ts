...
export const LIFE_BRANCHES:readonly LifeBranch[]=[
 ...
 branch("hobbies","Hobbies & Interests","Interests, creative practice, collections, and recreation.","internal",["hobby","music","sport","game","art","collection","recipe","garden"],["Interests","Practice","Collections","Events","Ideas"]),
